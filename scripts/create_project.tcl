...
set project_name "WasmFpgaInterconnect"
...
set obj [get_filesets sources_1]
set files_vhd [list \
 [file normalize "${project_src}/WasmFpgaInterconnect.vhd" ]\
 [file normalize "${project_src}/WasmFpgaInterconnectPackage.vhd" ]\
...
set obj [get_filesets sources_1]
set_property -name "top" -value "WasmFpgaInterconnect" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "top_file" -value "${project_src}/WasmFpgaInterconnect.vhd" -objects $obj
...
set files [list \
 "[file normalize "${project_tb}/tb_WasmFpgaInterconnect.vhd"]"\
...
set obj [get_filesets sim_1]
set_property "top" "tb_WasmFpgaInterconnect" $obj
